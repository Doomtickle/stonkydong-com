<section class="flex flex-wrap items-center lg:pb-16 xl:pb-32">
  <div class="relative flex flex-wrap items-start justify-center px-4 pb-16 h-4/5 pt-28 lg:pt-0 lg:w-1/2 lg:pr-32">
    ...
    <div class="p-6 font-semibold tracking-wide gradient rounded-xl well">
      ...
      1995 called and said your sex life sucks because you manage your portfolio like an octogenarian.
      </p>
      <p class="mt-3 text-gray-200 sm:mx-auto sm:text-xl md:mt-5">
      Try this shit and see if it's any better. It's so easy. Just download the app and start buying dips.
      </p>
    </div>
